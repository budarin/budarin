...
- Дизайн, UI/UX: настоящие дизайн-систем, способные генерировать любое количество тем в runtime. Разработка UI-kit являющихся частью дизайн-системы. Разработка headless компонент и компонент, связанных с источниками данных
